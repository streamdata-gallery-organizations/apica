...
apis:
- name: Aggregated Checks API Checks {checkId} Aggregated?mostrecent={mostrecent}&amp;detail_level={detail_level}&amp;scope={scope}
  x-api-slug: aggregated-checks-api
  description: For a specific check - gets aggregated data and SLA for the most recent
    periods in a scope.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/apica-logo.png
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/apica/master/_listings/apica/get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/apica/master/_listings/apica/get-openapi.md
- name: Aggregated Checks API Checks Aggregated?mostrecent={mostrecent}&amp;detail_level={detail_level}&amp;scope={scope}
  x-api-slug: aggregated-checks-api
  description: For all user visible checks - gets aggregated data and SLA for the
    most recent periods in a scope.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/apica-logo.png
  humanURL: https://www.apicasystem.com
  baseURL: :////
  tags: Aggregated
...
- name: Alerts API Deleting an alert
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/apica/master/_listings/apica/alertsconfigsalertid--openapi.md
- name: Alerts API Listing alerts by subject
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/apica/master/_listings/apica/alertsconfigssubjectid--openapi.md
- name: Alerts API Triggered alerts
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/apica/master/_listings/apica/alertstriggered--openapi.md
- name: Alerts API
  x-api-slug: alerts-api
  description: Apica provides the most effective technology for optimizing the performance
    of cloud and mobile applications. Apica offers companies and developers alike
